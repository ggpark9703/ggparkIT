...
var EC_MEMBER_ASYNC_SAVE_ID = (function($){
    ...
    var $controller = {
        ...
        init : function(){
            _super = this;            
            _super.$loginModules = EC$(document).find(_super.sloginModuleClassName); 
        },        
        /**
         * progress
         */
        ...
        setSaveIdLogoffUserInfo : function(){               
            ...
            var sUserMemberIdCookieVar = EC$.cookie(options.memberSaveIdCookieString) || '';
            ...
            var reset = function(){
                EC$.each(_super.$loginModules.find('input[name="member_id"]'), function(){
                   EC$(this).val(getUrlParamValue('member_id'));
                });
                
                EC$.each(_super.$loginModules.find('input[name="check_save_id"]'), function(){
            ...
            EC$.ajax({
                ...
                success: function(response){     
                    switch (response.code) {
                        case '0001' :
                            EC$.each(_super.$loginModules.find('input[name="member_id"]'), function(){
                                EC$(this).val(getUrlParamValue('member_id') || response.data.convert_str);
                            });
                        ...
                        case '9999' :
                            ...
                            EC$.each(_super.$loginModules.find('label[for^="check_save_id"]'), function(){                            
                                EC$(this).remove();
                            });                            
                        break;
                        default :
        ...
        setSaveIdLoginUserInfo : function(){    
            ...
            var sMemberId = EC$('#' + _super.sFormId).find('input[name="member_id"]').val();            
                ...
                EC$.ajax({
                    ...
                    success: function(response){      
                        if (response.code == '0001') {
                            ...
                            EC$.each(EC$('input[name="check_save_id"]'), function(){
        ...
        constructSaveId : function(){
            EC$.cookie(options.memberSaveIdCookieString, _super.sEncrytMemberId, {expires: 365, path: '/'});
        },
        /**
         * remove save id cookie
         */        
        destructSaveId : function(){
            EC$.cookie(options.memberSaveIdCookieString, null, {path: '/'});
        }
    };
