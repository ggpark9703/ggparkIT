...
var MOBILE_BOARD_SPREAD = {
    init : function ()
    {
        ...
        if (bIsUseSpread == false) {
            EC$('.eBulletinSpreadBtnArea').hide();
        }
    },
    setEvent : function ()
    {
        EC$('[id^=eBulletinSpreadBtn_]').click(function () {
            var iNo = MOBILE_BOARD_SPREAD.getBulletinNo(EC$(this).attr('id'));
            if (iNo > 0) {
    ...
    {
        if (sAction == 'OPEN') {
            EC$('#eBulletinSpreadBtnUp_'+iNo).css('display', 'none');
            EC$('#eBulletinSpreadBtnDown_'+iNo).css('display', 'inline');
        } else {
            EC$('#eBulletinSpreadBtnUp_'+iNo).css('display', 'inline');
            EC$('#eBulletinSpreadBtnDown_'+iNo).css('display', 'none');
        }
    },
    setBulletinSpreadClose : function (iNo)
    {
        EC$('#content_view_'+iNo).remove();
    },
    ...
    setbulletinSpreadContent : function (sData)
    {
        ...
        EC$('#eBulletinSpreadBtn_'+sData.no).parents('li').after(this.getBulletinContentForm(sData));
        if (sData.ucc_url) EC$('.ec-ucc-media-box-'+ sData.no).replaceWith(APP_BOARD_UCC.getPreviewElement(sData.ucc_url));
    },
    ...
    {
        if (EC$('#content_view_'+iNo).length > 0) {
            return true;
        }
        return false;
    },
