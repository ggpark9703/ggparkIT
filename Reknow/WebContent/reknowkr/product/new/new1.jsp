...
{    
   // 링크가 눌려지면 해당 함수가 호출됨.
   document.loginf.action = "CartIn.in";
   document.loginf.method = "post";
   document.loginf.enctype="multipart/form-data"
...
{    
   // 링크가 눌려지면 해당 함수가 호출됨.
   document.loginf.action = "buypd.pd";
   document.loginf.method = "post";
...
<ul class="btn_2">
<form name="loginf"> 	
<input type="hidden" name="PRODUCT_ID" value="10" class="form-control">
<input type="hidden" name="PRODUCT_DESC" value="STONE BOLD RING IS REGENO" class="form-control">
<input type="hidden" name="PRODUCT_NAME" value="STONE BOLD RING" class="form-control">
<input type="hidden" name="PRODUCT_PRICE" value="12000" class="form-control">
<input type="hidden" name="PRODUCT_FILE"  value="jun.jpg">
<a href="javascript:;" onclick="buyPage()">BUY</a>
<span class="displaynone">Sold out</span>
<a href="javascript:;"  onclick="goPage()">ADD TO CART</a>
</form>
</ul>
</div>
