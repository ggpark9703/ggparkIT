...
<%
	List qnadata=(List)request.getAttribute("qnalist");
%>
...
<link rel="stylesheet" type="text/css" href="./reknowkr/img.echosting.cafe24.com/editors/froala/css/froala_style_ec.min.css" charset="utf-8"/>
...
<td>공지</td>
                ...
                <td class="subject">
                    <span class="displaynone">
                        <a href="#none" onclick="BOARD.viewTarget('739','6',this);"><img src="./reknowkr/img.echosting.cafe24.com/skin/base_ko_KR/board/btn_unfold.gif" alt="내용 보기"/></a>
                    </span>
                     <a href="readf99d.html?no=739&amp;board_no=6" style="color:#555555;">(꼭 확인해주세요!) NOTICE</a> <img src="./reknowkr/img.echosting.cafe24.com/design/skin/admin/ko_KR/ico_hit.gif"  alt="HIT" class="ec-common-rwd-image" /><span class="comment"></span>
                </td>
                <td>reknow</td>
                <td class="txtLess displaynone">05/24</td>
                <td class="txtLess displaynone">2164</td>
                <td class="txtLess displaynone">0</td>
                <td class="displaynone"><img src="./reknowkr/img.echosting.cafe24.com/skin/base_ko_KR/board/ico_point0.gif" alt="0점"/></td>
            </tr>
<tr style="background-color:#FFFFFF; color:#555555;" class="xans-record-">
<td>공지</td>
                <td class="thumb"><a href="../../product/detail.html"></a></td>
                ...
                <td class="subject">
                    <span class="displaynone">
                        <a href="#none" onclick="BOARD.viewTarget('1968','6',this);"><img src="./reknowkr/img.echosting.cafe24.com/skin/base_ko_KR/board/btn_unfold.gif" alt="내용 보기"/></a>
                    </span>
                     <a href="read54bc.html?no=1968&amp;board_no=6" style="color:#555555;">배송 조회 방법</a> <img src="./reknowkr/img.echosting.cafe24.com/design/skin/admin/ko_KR/ico_hit.gif"  alt="HIT" class="ec-common-rwd-image" /><span class="comment"></span>
                </td>
                <td>reknow</td>
...
<tbody class="xans-element- xans-board xans-board-list-4 xans-board-list xans-board-4"><!--
			...
			QnaBean ql=(QnaBean)qnadata.get(i);%><tr style="background-color:#FFFFFF; color:#555555;" class="xans-record-">
<td><%=ql.getQ_NUM() %></td>
                <td class="thumb"><a href="/product/detail.html?product_no=493"><img src="//reknow.kr/web/product/tiny/202103/f10ed4482dc9f87d5c2414fdd2802403.jpg"  border="0" alt="" /></a></td>
                <td class="displaynone"></td>
                <td class="subject">
                    <span class="displaynone">
                        <a href="#none" onclick="BOARD.viewTarget('6988','6',this);"><img src="http://img.echosting.cafe24.com/skin/base_ko_KR/board/btn_unfold.gif" alt="내용 보기"/></a>
                    </span>
                     <a href="/board/product/read.html?no=6988&board_no=6" style="color:#555555;"><%=ql.getQ_NAME() %></a> <img src="//img.echosting.cafe24.com/design/skin/admin/ko_KR/ico_lock.gif"  alt="비밀글" class="ec-common-rwd-image" /><img src="//img.echosting.cafe24.com/design/skin/admin/ko_KR/ico_new.gif"  alt="NEW" class="ec-common-rwd-image" /><span class="comment"></span>
                </td>
                <td><%=ql.getQ_PASSWORD() %></td>
                <td class="txtLess displaynone">03/31</td>
                <td class="txtLess displaynone">2</td>
                <td class="txtLess displaynone">0</td>
...
</select> <input id="search" name="search" fw-filter="" fw-label="" fw-msg="" class="inputTypeText" placeholder="" value="" type="text"  /> <a href="writePage.in" onclick=><span class="sherbetbt_b white">글쓰기</span></a></p>
    </fieldset>
</div>
</form>
...
<li class="xans-record-"><a href="list5639.html?board_no=6&amp;page=1" class="this">1</a></li>
        <li class="xans-record-"><a href="list0710.html?board_no=6&amp;page=2" class="other">2</a></li>
          <li class="xans-record-"><a href="list72d7.html?board_no=6&amp;page=3" class="other">3</a></li>
        <li class="xans-record-"><a href="list54d0.html?board_no=6&amp;page=4" class="other">4</a></li>
          <li class="xans-record-"><a href="list2060.html?board_no=6&amp;page=5" class="other">5</a></li>
        <li class="xans-record-"><a href="listed7e.html?board_no=6&amp;page=6" class="other">6</a></li>
          <li class="xans-record-"><a href="listf965.html?board_no=6&amp;page=7" class="other">7</a></li>
        <li class="xans-record-"><a href="listd934.html?board_no=6&amp;page=8" class="other">8</a></li>
<li class="xans-record-"><a href="list0b82.html?board_no=6&amp;page=9" class="other">9</a></li>
<li class="xans-record-"><a href="listb0c3.html?board_no=6&amp;page=10" class="other">10</a></li>
    </ol>
</div>
</div>
