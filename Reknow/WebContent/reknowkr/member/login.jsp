...
{    
   // 링크가 눌려지면 해당 함수가 호출됨.
   document.loginf.action = "loginProcess.in";
   document.loginf.method = "post";
   document.loginf.submit();
   //a herf누르면 여기로 이동하면서 post방식으로 sumbit함 
}
</script>
...
<form name="loginf">
            ...
            <label class="id"><span>ID</span><input type="text" name="id" id="id" value=""></label>
           <label class="id"><span>Password</span><input type="password" name="pw" id="pw" value=""></label>
         
           
            <ul style="margin-top:30px;">
             <a href="javascript:;"  onclick="goPage()" class="login">login</a>
</form>
                <br/><br/><br/><a href="join.in" class="join">join</a><!-- 로그인 프로세스로 데이터를 정보를 가지고 이동~ -->
            </ul>
            </form>
<li>
...
EC$(function(){
AuthSSL.Bind('member_form_6675714616', ["member_form_6675714616::member_id","member_form_6675714616::member_passwd","member_form_6675714616::check_save_id[]","member_form_6675714616::member_check_save_id[]","member_form_6675714616::returnUrl","member_form_6675714616::forbidIpUrl","member_form_6675714616::use_login_keeping[]","member_form_6675714616::certificationUrl","member_form_6675714616::sIsSnsCheckid","member_form_6675714616::sProvider","member_form_6675714616::check_save_id","member_form_6675714616::use_login_keeping","member_form_6675714616::sLoginKey"]);
});
